...
constexpr Company::Company(
  ...
  , legalname_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, founding_),
  PROTOBUF_FIELD_OFFSET(::Company, legalname_),
...
const char descriptor_table_protodef_record_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\020\n\010founding\030\002 \001(\005\022\021\n\tlegalName\030\003 \001(\t\022\022\n\n"
  "occupation\030\004 \001(\t\022\027\n\017foreignActivity\030\005 \001("
  "\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_record_2eproto = {
  false, false, 121, descriptor_table_protodef_record_2eproto, "record.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_founding(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static void set_has_legalname(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
...
Company::Company(const Company& from)
  ...
  legalname_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    legalname_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_legalname()) {
    legalname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_legalname(), 
      GetArenaForAllocation());
  }
  ...
  ::memcpy(&founding_, &from.founding_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreignactivity_) -
    reinterpret_cast<char*>(&founding_)) + sizeof(foreignactivity_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&founding_) - reinterpret_cast<char*>(this)),
...
inline void Company::SharedDtor() {
  ...
  legalname_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      legalname_.ClearNonDefaultToEmpty();
    }
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&founding_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _Internal::set_has_founding(&has_bits);
          founding_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          auto str = _internal_mutable_legalname();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.legalName");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_founding(), target);
  }

  // optional string legalName = 3;
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_legalname().data(), static_cast<int>(this->_internal_legalname().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "Company.legalName");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_legalname(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreignactivity(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional int32 founding = 2;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_founding());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _internal_set_legalname(from._internal_legalname());
    }
    if (cached_has_bits & 0x00000004u) {
      _internal_set_occupation(from._internal_occupation());
    }
    if (cached_has_bits & 0x00000008u) {
      founding_ = from.founding_;
    }
    if (cached_has_bits & 0x00000010u) {
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &legalname_, lhs_arena,
      &other->legalname_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Company, founding_)>(
          reinterpret_cast<char*>(&founding_),
          reinterpret_cast<char*>(&other->founding_));
}
